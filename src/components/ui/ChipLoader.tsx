...
interface Props {
  className?: string;
  /** sm = inline row loaders, md = cards/modals, lg = section/page loaders (default), xl = full-page */
  size?: "sm" | "md" | "lg" | "xl";
}

export default function ChipLoader({ className = "", size = "lg" }: Props) {
  return (
    <div className={`chip-loader-main ${className}`}>
      <svg className={`chip-loader-svg chip-loader-${size}`} viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
        <defs>
